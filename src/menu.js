...
export class Menu {
    ...
    creatureMenu() {
        ...
        coordsWin.x = bounds.maxX - coordsWin.width - (20 * this.scale)
        coordsWin.y = bounds.minY + title.height + (20 * this.scale)
        coordsWin.zIndex = 1
        ...
        coordsX.x = bounds.maxX - coordsWin.width - (5 * this.scale)
        ...
        coordsY.x = bounds.maxX - coordsWin.width - (5 * this.scale)
        ...
        moveButton.x = bounds.minX + (10 * this.scale)
        moveButton.y = bounds.minY + title.height + (20 * this.scale)
        moveButton.zIndex = 1
        ...
        // moveText.on('mouseup',(e) => {
        //     moveButton.emit('mouseup', e)
        // })
        ...
        buildButton.x = bounds.minX + (10 * this.scale)
        ...
        mineButton.x = bounds.minX + (10 * this.scale)
